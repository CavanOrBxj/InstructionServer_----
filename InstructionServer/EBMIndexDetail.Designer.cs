namespace InstructionServer
{
    partial class EBMIndexDetail
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.pnlDes2 = new InstructionServer.Layouts.EBMIndexDes();
            this.pnlProgramStreamInfo = new InstructionServer.Layouts.EBMIndexProgramStreamInfoLayout();
            this.pnlDetChlDes = new InstructionServer.Layouts.EBMIndexDetChlDes();
            this.pnlResourceCode = new InstructionServer.Layouts.EBMIndexResourceCode();
            this.SuspendLayout();
            // 
            // btnOK
            // 
