...
{
    public class sjj1313
    {
        [DllImport(@".\sjj1313\libTassYJGBCmd_SJJ1313.dll", EntryPoint = "OpenDevice", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int OpenDevice(ref IntPtr phDeviceHandle);

        [DllImport(@".\sjj1313\libTassYJGBCmd_SJJ1313.dll", EntryPoint = "CloseDevice", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int CloseDevice(ref int phDeviceHandle);

        //导入证书
        [DllImport(@".\sjj1313\libTassYJGBCmd_SJJ1313.dll", EntryPoint = "ImportTrustedCert", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int ImportTrustedCert(ref int phDeviceHandle, StringBuilder strcertPath);

        //使用设备私钥计算数据签名
        [DllImport(@".\sjj1313\libTassYJGBCmd_SJJ1313.dll", EntryPoint = "GenerateSignatureWithDevicePrivateKey", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        //使用设备私钥计算数据签名(字符串模式)
        [DllImport(@".\sjj1313\libTassYJGBCmd_SJJ1313.dll", EntryPoint = "GenerateSignatureWithDevicePrivateKey_String", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        //使用证书验证数据签名
        [DllImport(@".\sjj1313\libTassYJGBCmd_SJJ1313.dll", EntryPoint = "VerifySignatureWithTrustedCert", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        //使用证书验证数据签名（字符串）
        [DllImport(@".\sjj1313\libTassYJGBCmd_SJJ1313.dll", EntryPoint = "VerifySignatureWithTrustedCert_String", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int VerifySignatureWithTrustedCert_String(ref int phDeviceHandle, int nDataType, byte[] pucData);

        //计算数据摘要
        [DllImport(@".\sjj1313\libTassYJGBCmd_SJJ1313.dll", EntryPoint = "CalcHash", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        [DllImport(@".\sjj1313\libTassYJGBCmd_SJJ1313.dll", EntryPoint = "Platform_CalculateSignature", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        //2017-8-2密码器接口
        //平台签名验证
        [DllImport(@".\sjj1313\libTassYJGBCmd_SJJ1313.dll", EntryPoint = "Platform_VerifySignature", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        public int OpenScrambler(ref IntPtr phDeviceHandle)
        {
        ...
        public string Platform_CalculateSingature_String(int PhDeviceHandle, int DataType, byte[] strpcData, int size, ref byte[] strSingBody)
        {
            ...
            {
                LogHelper.WriteLog(typeof(sjj1313),"sjj签名失败");
            }
